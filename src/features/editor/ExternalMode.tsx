    ...
    <StyledAlert>
      ...
      >
        External Host
              ...
              <Modal title="External Host of Data Editor" opened={isOpen} onClose={closeModal} centered>
        <Group>
          ...
          <Text>
            ...
            <Anchor href="https://jsoncrack.com">Data Editor</Anchor>. Your continued support is
            ...
            We kindly encourage you to consider upgrading to the premium version, which not only
                          enhances your experience but also contributes to the ongoing development of Data Editor.
          </Text>
        </Group>
